...
const AuthModel:React.FC<AuthModelProps> = () => {
    ...
    return (<>
    <div
        className='absolute top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-60' onMouseDown={closeModal}
    ></div>
    <div className='w-full sm:w-[450px]  absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]  flex justify-center items-center'>
        <div className='relative w-full h-full mx-auto flex items-center justify-center'>
            <div className= "bg-dark-layer-1 rounded-lg shadow relative w-full mx-6">
                ...
                { //short if
            authModal.type === "login" ? <Login/> : authModal.type === "register" ? <Registr/> : <PwReset/> }
            </div>
