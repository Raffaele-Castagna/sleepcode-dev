...
// Presa sa SO, JS non ha LL built-in
class LinkedList {
	value: number;
...
/**
 * Definizione di una linked list
 * function ListNode(val, next) {
 *     this.val = (val===undefined ? 0 : val)
 *     this.next = (next===undefined ? null : next)
 * }
 */
// Non cambiare il nome della funzione
  ...
  export const reverseLinkedListHandler = (fn: any) => {
	try {
		...
		console.log("Errore da reverseLinkedListHandler ", error);
...
export const reverseLinkedList: Problem = {
	...
	problemStatement: `<p class='mt-3'>Data la <code>head</code> di una linked list, inverti la lista, e dai in output <em>la lista invertita</em>.</p>`
	,
	examples: [
		{
			id: 0,
	...
	constraints: `<li class='mt-2'>Il numero di nodi nella lista è tra <code>[0, 5000]</code>.</li>
